...
namespace Jojatekok.PoloniexAPI.MarketTools
{
    public class Markets : IMarkets
    {
        ...
        public IDictionary<CurrencyPair, IMarketData> GetSummarySync()
        {
            return GetSummary();
        }
        ...
        public IOrderBook GetOpenOrdersSync(CurrencyPair currencyPair, uint depth)
        {
            return GetOpenOrders(currencyPair, depth);
        }
        ...
        public IList<IMarketChartData> GetChartDataSync(CurrencyPair currencyPair, MarketPeriod period, DateTime startTime, DateTime endTime)
        {
            return GetChartData(currencyPair, period, startTime, endTime);
        }
