...
namespace Jojatekok.PoloniexAPI
{
    public interface IMarkets
    {
        ...
        /// <summary>Synchronous version of GetSummaryAsync()</summary>
        IDictionary<CurrencyPair, IMarketData> GetSummarySync();
        ...
        /// <summary>Synchronous version of GetOpenOrdersAsync()</summary>
        IOrderBook GetOpenOrdersSync(CurrencyPair currencyPair, uint depth = 50);
        ...
        /// <summary>Synchronous version of GetChartDataAsync()</summary>
        IList<IMarketChartData> GetChartDataSync(CurrencyPair currencyPair, MarketPeriod period, DateTime startTime, DateTime endTime);
    }
}