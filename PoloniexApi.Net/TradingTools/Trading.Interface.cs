...
namespace Jojatekok.PoloniexAPI
{
    public interface ITrading
    {
        ...
        IList<IOrder> GetOpenOrders(CurrencyPair currencyPair);

        AllOrders GetAllOpenOrders();
        ...
        bool DeleteOrder(CurrencyPair currencyPair, ulong orderId);
        ulong MoveOrder(CurrencyPair currencyPair, ulong orderId, double pricePerCoin, double amountQuote);
    }
}
